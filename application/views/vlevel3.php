...
<script type="text/javascript" src="<?php echo $base; ?>js/productstore3.js"></script>
<script type="text/javascript" src="<?php echo $base; ?>js/timelevel3.js"></script>
...
<div class="panel panel-default " style="border-collapse:0px solid red;">
    <div class="panel-heading">LEVEL 3<span class="pull-right"><div id="divCounter3"></div></span></div>
    <div class="panel-body" id="">
    
    <?php
    echo '<div class="row">';
    echo '<div class="col-md-3 marginright marginleft" check="false" onclick="checkSquare(this);" id="egg"></div>';
  
    echo '<div class="col-md-3 marginright"  class="norepeat" check="false" id="oval" onclick="checkSquare(this);"></div>';
    
echo '<div class="col-md-3" check="false" onclick="checkSquare(this);" id="triangle"></div>';    
echo '<div class="circleBase col-md-3 type1 marginright" id="oval" check="false" onclick="checkSquare(this);"></div>';
...
echo '</br>';
echo '<div class="row">';
echo '<div class="col-md-3 marginright marginleft"  class="norepeat" check="false" id="oval" onclick="checkSquare(this);"></div>';
      echo '<div class="col-md-3 marginright " check="false" onclick="checkSquare(this);" id="square"></div>';
    echo '<div class="col-md-3 marginright marginleft" check="false" onclick="checkSquare(this);" id="egg"></div>';
            echo '<div class="col-md-3 marginright " check="false" onclick="checkSquare(this);" id="square"></div>';
      echo '<div class="col-md-3 marginright " check="false" onclick="checkSquare(this);" id="square"></div>';
