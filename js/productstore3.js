  function checkSquare(e){
      ...
      if(check == "true"){
        ...
        $(e).attr("check","true");
        if($(e).attr("id")=="rect" || $(e).attr("id")=="circle" ||$(e).attr("id")=="triangle" ||$(e).attr("id")=="egg" ||$(e).attr("id")=="oval" ){
       //   alert("imside");
...
function level1(){
    //localStorage.clear();
  console.log(obj);
  var timeset=document.getElementById('divCounter3').innerHTML; //alert(timeset);
 var strUrl = '/sugoi/index.php/clevel/level3';
      $.ajax({
      url: strUrl,
      type: "post",
